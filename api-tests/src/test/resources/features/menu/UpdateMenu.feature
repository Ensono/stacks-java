...
Feature: Update Menu
  ...
  Scenario: Update menu - happy path
    ...
    And the following menu data:
      ...
      | The Lounge Cafe | British Cuisine | d211f1ee-6c54-4b01-90e6-d701748f0852 | false   |
    ...
    When I update the menu with the following data:
      | name       | description                  | tenantId                             | enabled |
      | The Lounge | New Style Of British Cuisine | d211f1ee-6c54-4b01-90e6-d701748f0852 | true    |
  ...
  Scenario: Bad request for update menu - empty 'enabled' field
    ...
    When I update the menu with the following data:
      | name              | description         | tenantId                             | enabled |
      | The new menu name | Updated Description | d211f1ee-6c54-4b01-90e6-d701748f0852 |         |
    Then the returned status code is 400
