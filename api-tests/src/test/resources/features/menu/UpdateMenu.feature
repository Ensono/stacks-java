...
#      | A new test menu name | 1Test Description | d211f1ee-6c54-4b01-90e6-d701748f0852 | true    |
#    When I create the menu
#    Then the menu was successfully created
#
#    When I update the menu with fallowing data:
#      | name                      | description                  | tenantId                             | enabled |
#      | Update the test menu name | 1Update the test description | d211f1ee-6c54-4b01-90e6-d701748f0852 | false   |
