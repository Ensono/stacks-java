...
/**
 * Deletes the transient report directories generated by the untagged test check so the enforcement
 * script sees empty folders and exits successfully.
 */
final class UntaggedTestArtifactsCleaner {
  ...
  private static final List<Path> DIRECTORIES_TO_DELETE =
      List.of(Paths.get("target", "failsafe-reports"), Paths.get("target", "site", "serenity"));
