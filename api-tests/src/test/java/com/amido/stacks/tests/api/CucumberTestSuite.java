...
/**
 * Runs Cucumber features via JUnit 5 Platform Suite Engine. Specifies features location to enable
 * test discovery. Additional configuration (glue, tags, plugins) is loaded from
