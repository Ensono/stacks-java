...
public enum ExceptionMessages {
    ...
    CATEGORY_ALREADY_EXISTS("A category with the id '(.*)' does not exist for menu with id '(.*)'."),
    CATEGORY_DOES_NOT_EXIST("A category with the name '(.*)' already exists for the menu with id '(.*)'."),
