...
public class ServiceBusTopicListener {
    ...
    public static void main(String[] args) throws Exception, ServiceBusException {
        String connectionString = "Endpoint=sb://amido-stacks-java.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=01D8OSZUUJfyD0B3vCqWsK9jkmzzmC8SjE9kGMlpLc8=";

        SubscriptionClient client = new SubscriptionClient(
                new ConnectionStringBuilder(connectionString, "menu-updates/subscriptions/Subscription1"),
    ...
    static void registerMessageHandlerOnClient(SubscriptionClient receiveClient) throws Exception {
        ...
        receiveClient.registerMessageHandler(
                ...
                new
                        ...
                        MessageHandlerOptions(1, false, Duration.ofMinutes(1)));
