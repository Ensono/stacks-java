...
import com.amido.stacks.menu.api.v1.controller.UpdateMenuController;
...
public class UpdateMenuControllerImpl implements UpdateMenuController {
  ...
  @Override
  public ResponseEntity<ResourceUpdatedResponse> updateMenu(UUID menuId, @Valid UpdateMenuRequest body,
